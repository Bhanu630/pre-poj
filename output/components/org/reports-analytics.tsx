...
const chartData = [
  { day: "Tue 20", meals: 140, items: 60 },
  { day: "Wed 21", meals: 210, items: 90 },
  { day: "Thu 22", meals: 180, items: 75 },
  { day: "Fri 23", meals: 260, items: 120 },
  { day: "Sat 24", meals: 320, items: 150 },
  { day: "Sun 25", meals: 290, items: 110 },
  { day: "Mon 26", meals: 230, items: 95 },
]

const topDonations = [
  { name: "Ramesh Kumar", meals: 2100 },
  { name: "NGO Friends", meals: 960 },
  { name: "Karthik Varma", meals: 180 },
]

const stats = [
  { label: "Total Donations", value: "24", icon: Gift },
  { label: "Total Meals", value: "1,230", icon: Utensils },
  { label: "Total Donors", value: "18", icon: Users },
  { label: "Total Beneficiaries", value: "8", icon: Sprout },
]

export function ReportsAnalytics() {
  const maxMeals = Math.max(...topDonations.map((d) => d.meals))
