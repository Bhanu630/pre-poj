...
const stats = [
  { icon: HandCoins, value: "$48M+", label: "Donated to causes" },
  { icon: Building2, value: "2,400+", label: "Verified organizations" },
  { icon: Users, value: "320,000", label: "Generous donors" },
  { icon: Globe2, value: "76", label: "Countries reached" },
]
        ...
        {stats.map((stat) => {
          ...
          return (
            <div key={stat.label} className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 text-2xl font-extrabold text-primary-foreground sm:text-3xl">{stat.value}</p>
