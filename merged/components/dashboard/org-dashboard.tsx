...
export function OrgDashboard({
  ...
  // Use real org name from Firestore; fall back to userName
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Topbar — search bar and New Campaign button removed */}
        ...
        <main className="flex-1 p-6 lg:p-8 max-w-7xl w-full mx-auto">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mt-1">
                {displayName} — here&apos;s what&apos;s happening across your campaigns today.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              ...
              <a href="/org/donors" className="text-sm font-medium text-blue-700 hover:text-blue-800">
                View all
              </a>
            </div>
