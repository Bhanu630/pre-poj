...
import { Heart, ShieldCheck, HandHeart, ArrowLeft, BarChart3 } from "lucide-react"

const highlights = [
  { icon: ShieldCheck, label: "Verified organizations", desc: "Every NGO is vetted and audited." },
  { icon: BarChart3, label: "Full transparency", desc: "Track exactly where your money goes." },
  { icon: HandHeart, label: "Real impact", desc: "Donations that create lasting change." },
]
      ...
      <aside className="relative hidden w-[44%] flex-col justify-between overflow-hidden bg-primary px-12 py-12 text-primary-foreground lg:flex">
        ...
        <div className="max-w-md">
          ...
          <p className="mt-4 text-pretty leading-relaxed text-primary-foreground/80">
            Join a community of donors funding verified projects in education, clean water, and
